    ...
    if (status == google.maps.places.PlacesServiceStatus.OK) {
        ...
        for (var i = 0; i < results.length; i++) {
            ...
            if (typeof place.photos != 'undefined' && typeof place.photos[0] != 'undefined' && typeof place.photos[0].getUrl({
                ...
                placeCover = 'src/img/place-default.jpg';
            }
            $('#result').append('<div id="' + placeId + '" style="margin-bottom:60px;"><p><img src="' + placeCover + '" /></p><p>' + place.name + ' | open : ' + placeOpen + '<a href="#" id="' + placeId + '" class="add-trip"> Ajouter a mon trip</a></p></div>'); // on renseigne la liste des resultats à l'endroit indiqué
